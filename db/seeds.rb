['juan', 'andrea', 'leon', 'andres', 'natalia', 'camilo', 'rusbel', 'sebas'].each do |name|
...
owner = User.find_by(email: 'sebas@molinas.com')

['sebas:1', 'leon:2', 'andrea:random'].each do |participant|

name, raw_role = participant.split(':')

rol = raw_role == 'random' ? [1, 2].sample : raw_role
